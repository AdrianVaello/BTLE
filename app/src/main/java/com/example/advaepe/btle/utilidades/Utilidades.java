package com.example.advaepe.btle.utilidades;
...
public class Utilidades {
    ...
    public static final String CAMPO_MOMENTO="momento";
    public static final String CAMPO_UBICACION="ubicacion";
    public static final String CAMPO_VALOR="valor";
    public static final String CAMPO_IDMAGNITUD="idMagnitud";


    public static final String CREAR_TABLA_LECTURAS= "CREATE TABLE "+ TABLA_LECTURAS+ "("+CAMPO_MOMENTO+
            " TEXT,"+CAMPO_UBICACION+ " TEXT,"+CAMPO_VALOR+" INTEGER,"+CAMPO_IDMAGNITUD+" TEXT )";
    ...
    public static UUID stringToUUID(String uuid ) {
        ...
        UUID res = new UUID( com.example.advaepe.btle.utilidades.Utilidades.bytesToLong( masSignificativo.getBytes() ), com.example.advaepe.btle.utilidades.Utilidades.bytesToLong( menosSignificativo.getBytes() ) );
